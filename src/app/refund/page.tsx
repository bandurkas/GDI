...
export default function RefundPage() {
    ...
    const refund = dictionary.refund;
            ...
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <div className="flex items-center justify-center gap-2 text-slate-500 dark:text-slate-400 font-medium">
                        <Clock size={16} />
                        <span>{refund.lastUpdated}</span>
                    </div>
                </div>

                <div className="space-y-8">
                    {refund.sections.map((section, index: number) => (
                        <div
                            key={index}
                ...
                <div className="mt-16 p-8 rounded-3xl bg-indigo-600 text-white shadow-2xl shadow-indigo-500/20 text-center">
                    <h2 className="text-2xl font-bold mb-4">Refund Inquiry</h2>
                    <p className="mb-8 text-indigo-100 max-w-xl mx-auto leading-relaxed">
                        To initiate a refund request, please gather your order details and contact our billing specialists.
                    </p>
                    <a
