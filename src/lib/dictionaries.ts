...
const en = {
    ...
    home: {
        ...
        pillarInfra: {
            ...
            points: ["Facility selection matched to power, cooling and budget", "Installation, remote hands and optional managed server operations: monitoring, patching, backups, 24/7", "Instant indicative pricing with an online calculator"],
            from: "From",
            perMonth: "/ month",
...
const id: Dictionary = {
    ...
    home: {
        ...
        pillarInfra: {
            ...
            points: ["Pemilihan fasilitas sesuai daya, pendinginan dan anggaran", "Instalasi, remote hands dan opsional operasional server terkelola: monitoring, patching, backup, 24/7", "Harga indikatif seketika dengan kalkulator online"],
            from: "Mulai",
            perMonth: "/ bulan",
